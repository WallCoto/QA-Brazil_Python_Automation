...
class UrbanRoutesPage:
    ...
    comfort_icon_locator = (By.XPATH, '//img[contains(@src, "kids")]')
    comfort_active = (By.XPATH, '//div[contains(@class, "tcard active") and .//img[contains(@src, "kids")]]')
    ...
    switch_blanket_active = (By.CSS_SELECTOR, 'input.switch-input')
